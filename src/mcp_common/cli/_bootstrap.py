...
def run_cli(
    ...
    *,
    ...
    1. :func:`mcp_common.env.load_env` — loads ``.env`` files using
       mcp-common's standard precedence (existing env > repo .env >
       parent .env).
    2. :func:`mcp_common.logging.setup_logging` — configures structured
