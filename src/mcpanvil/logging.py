...
a separate triage agent / the failure-correlation pipeline. Route the channel to a durable sink
...
TRACE_LOGGER_NAME = "mcpanvil.trace"
...
def configure_trace_channel(
    ...
    *,
    ...
    failure-correlation pipeline **without** ever
...
def setup_logging(
    *,
    ...
    :func:`configure_trace_channel`). This is a deliberate behavior change:
...
def redact_config_from_settings(
    ...
    """Build redaction substrings and compiled key patterns from :class:`~mcpanvil.config.MCPSettings`."""
