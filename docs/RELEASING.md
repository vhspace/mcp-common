...
```bash
gh release create vX.Y.Z --repo your-org/<repo> --title "vX.Y.Z" --generate-notes
```
...
- [your-org/network-mcp#9](https://github.com/your-org/network-mcp/issues/9) — `switch_db/` at repo root broke packaged installs
- [your-org/network-mcp#10](https://github.com/your-org/network-mcp/pull/10) — fix PR (merged pattern)
- [your-org/example-mcp#119](https://github.com/your-org/example-mcp/issues/119) — `hardware_db/` at repo root, same class of bug

## Troubleshooting

### Release not created after merge

1. Check if the GitHub Release was created: `gh release list --repo your-org/<repo> --limit 1`
2. Confirm the squash commit used a release-triggering prefix (`feat:` / `fix:`).
3. Re-run the Release workflow manually from the Actions tab if needed.
