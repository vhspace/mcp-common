"""Optional Weights & Biases experiment tracking for MCP evals.
...
from mcpanvil.testing.eval.analyzer import _server_from_task_name as _server_from_task
...
_INSTALL_HINT = (
    ...
    'Install with: uv pip install "mcpanvil[eval-tracking]"'
)
