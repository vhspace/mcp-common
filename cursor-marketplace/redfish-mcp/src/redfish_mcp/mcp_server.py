...
def create_mcp_app() -> tuple[InstrumentedFastMCP, dict[str, Any]]:
    ...
    tools: dict[str, Any] = {}
    _wrap = mcp_remediation_wrapper(project_repo="togethercomputer/mcp-common")
    ...
    def _tool(**tool_kwargs: Any) -> Any:
        ...
        def deco(wrapped_fn: Any) -> Any:
            dual_mode_tool(
                mcp,
                name=wrapped_fn.__name__,
                description=inspect.getdoc(wrapped_fn),
                mcp_only=True,
                read_only=read_only,
                **tool_kwargs,
            )(wrapped_fn)
