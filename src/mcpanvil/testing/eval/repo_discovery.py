"""Discover MCP repos from mcp-plugin.toml files in the workspace.
...
class RepoInfo:
    ...
    name: str  # e.g. "example-mcp"
    github_url: str  # e.g. "https://github.com/your-org/example-mcp"
    github_repo: str  # e.g. "your-org/example-mcp"
    local_path: Path  # e.g. /workspaces/example-mcp
...
def discover_repos(workspace: Path) -> dict[str, RepoInfo]:
    ...
    """
    from mcpanvil.marketplace_builder import discover_plugins
