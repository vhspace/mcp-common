...
class _ToolMetadata:
    ...
    Stored in :mod:`mcpanvil.dual_mode._registry` per-FastMCP-instance and
    consumed by :func:`mcpanvil.dual_mode.build_cli_from_mcp` to synthesize
    ...
    Attributes:
        ...
        read_only: Explicit mutation classification for the enforced read-only
            ("eval") mode (see :mod:`mcpanvil.dual_mode._enforce`). ``True``
