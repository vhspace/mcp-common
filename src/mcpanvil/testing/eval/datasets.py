...
def scenario_to_sample(scenario: Scenario) -> Any:
    ...
    :func:`mcpanvil.testing.eval.scorers.cli_tool_use_scorer` never saw the
    explicit CLI commands even when they were set.
...
def scenarios_to_dataset(
    ...
    *,
    ...
    hand-rolling lossy converters. Each scenario is mapped with
