...
The headline capability of :mod:`mcpanvil`. Decorate a function with
...
through :func:`mcpanvil.cli.echo_result` so ``--json`` / human modes
work uniformly.
...
mutating tool/command executes. Read-only tools run normally;
...
the exposed surface harness-side. See :mod:`mcpanvil.dual_mode._enforce`.
...
from mcpanvil.dual_mode._cli_enforce import (
...
from mcpanvil.dual_mode._registry import tool_cli_subcommands
from mcpanvil.dual_mode.builder import build_cli_from_mcp
from mcpanvil.dual_mode.cli_context import CliContext
from mcpanvil.dual_mode.decorator import dual_mode_tool
