...
from mcpanvil.dual_mode._typer_params import PYDANTIC_FLATTEN_THRESHOLD
...
class TestAppNaming:
    ...
    def test_explicit_name_wins(self) -> None:
        ...
        try:
            ...
            app = build_cli_from_mcp(mcp, project_repo="your-org/netbox-mcp", name="my-custom-cli")
...
class TestEmptyRegistry:
    def test_no_tools_yields_help_only_app(self, runner: CliRunner) -> None:
        mcp = FastMCP("empty")
        try:
            app = build_cli_from_mcp(mcp, project_repo="your-org/empty-mcp")
            result = runner.invoke(app, ["--help"])
            assert result.exit_code == 0
...
class TestNestedPydanticFallback:
    ...
    def test_nested_pydantic_via_json_blob(self, mcp: FastMCP, runner: CliRunner) -> None:
        ...
        app = build_cli_from_mcp(mcp, project_repo="your-org/test")
        result = runner.invoke(
            app,
            [
                "create",
...
class TestSubgroupSuggestions:
    ...
    def _grouped_app(self, mcp: FastMCP) -> typer.Typer:
        ...
        return build_cli_from_mcp(mcp, project_repo="your-org/netbox-mcp")
...
class TestTopLevelDictParameter:
    ...
    def test_required_dict_via_json_blob(self, mcp: FastMCP, runner: CliRunner) -> None:
        ...
        app = build_cli_from_mcp(mcp, project_repo="your-org/awx-mcp")
        result = runner.invoke(
            app,
