...
``mcp-common`` so every downstream togethercomputer MCP picks it up via the
shared-skills promotion mechanism tracked in
`togethercomputer/mcp-common#95 <https://github.com/togethercomputer/mcp-common/issues/95>`_.
