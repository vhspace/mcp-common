...
Converts :class:`~mcpanvil.testing.eval.analyzer.EvalFailure` records into
...
from mcpanvil.testing.eval.repo_discovery import resolve_server_to_repo
...
def deduplicate(
    ...
    *,
    ...
    Args:
        ...
        repo_prefix: GitHub org prefix (neutral placeholder by default).
