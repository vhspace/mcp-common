...
def tool_cli_subcommands(mcp: FastMCP) -> dict[str, list[str]]:
    ...
    on ``mcp`` via :func:`mcpanvil.dual_mode.dual_mode_tool`, with duplicates
    ...
    the dual-mode framework. Typical use::
        ...
        from mcpanvil.dual_mode import tool_cli_subcommands
        from mcpanvil.testing.eval.scorers import cli_tool_use_scorer
