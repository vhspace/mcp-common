...
from mcpanvil.dual_mode._enforce import ensure_enforcement_installed
from mcpanvil.dual_mode._metadata import _ToolMetadata
from mcpanvil.dual_mode._naming import derive_cli_name
from mcpanvil.dual_mode._registry import get_tools, register
...
def dual_mode_tool(
    ...
    **mcp_tool_kwargs: Any,
    ...
    2. It appends a :class:`_ToolMetadata` entry to the registry keyed by
       ...
       :func:`mcpanvil.dual_mode.build_cli_from_mcp` can synthesize a
    ...
    Args:
        ...
        cli_aliases: Extra CLI subcommand names treated as equivalent to
            ...
            is surfaced by :func:`mcpanvil.dual_mode.tool_cli_subcommands`
        ...
        formatters: Optional ``{type: callable}`` mapping used by the CLI
            ...
            :func:`mcpanvil.cli.echo_result` as ``human_formatter``.
        ...
        read_only: Explicit mutation classification for enforced read-only
            ...
            :mod:`mcpanvil.dual_mode._enforce`). ``True`` marks the tool as
