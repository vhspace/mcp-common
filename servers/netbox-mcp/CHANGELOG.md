...
For full release history, see [GitHub Releases](https://github.com/togethercomputer/mcp-common/releases).

## Unreleased

### Features

- Add `netbox_get_objects_by_ids` tool for batch ID lookups ([#72](https://github.com/togethercomputer/mcp-common/issues/72))
...
- **Full read-path migration to `mcp_common.dual_mode`** (closes [#105](https://github.com/togethercomputer/mcp-common/issues/105); refs [togethercomputer/mcp-common#86](https://github.com/togethercomputer/mcp-common/issues/86))
  ...
  - The CLI is now assembled by `build_cli_from_mcp(...)` with per-invocation
    ...
    ([togethercomputer/mcp-common#103](https://github.com/togethercomputer/mcp-common/issues/103)),
  ...
  - `mcp-common` is now pinned to the released
    [`v0.24.0`](https://github.com/togethercomputer/mcp-common/releases/tag/v0.24.0) tag.
...
- Strip `__in` suffix from list-valued filters for NetBox 4.x ([#71](https://github.com/togethercomputer/mcp-common/issues/71))
